...
Ext.application({
    ...
    setArtistInfo: function(artist) {
        var main = Ext.getCmp('main'),
            ...
            artistSong = Ext.ComponentQuery.query('#artistSong')[0],    
        ...
        if(artist.saved) {
            ...
            saveArtistButton.setStyle('color: #eb6145; border: 2px solid #eb6145;');
            saveArtistButton.setText('Saved');
        } else {

            saveArtistButton.setStyle('color: #788b78; border: 2px solid #788b78;'); 
        ...
        artistSong.setHtml('<span class="artist-song">song: <i>'+artist.song+'</i></span>');
